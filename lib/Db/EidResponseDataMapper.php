 ...
 */
class EidResponseDataMapper extends QBMapper {
	public function __construct(IDBConnection $db) {
		parent::__construct($db, 'eidlogin_eid_responsedata', EidResponseData::class);
	}
	 ...
	 *
	 * @param $uid
	 * @return EidResponseData the fetched entity
	 * @throws DoesNotExistException if the item does not exist
	 */
	public function findByUid($uid) : EidResponseData {
	 ...
	 *
	 * @param $uid String The uid to match
	 */
